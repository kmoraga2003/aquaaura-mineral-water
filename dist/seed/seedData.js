...
exports.LocalStore = exports.INITIAL_PLANS = exports.INITIAL_PRODUCTS = void 0;
...
class LocalStore {
    static products = [...exports.INITIAL_PRODUCTS];
    static plans = [...exports.INITIAL_PLANS];
    static orders = [];
    static messages = [];
}
...
async function seedFirestore() {
    ...
    try {
        const prodRef = firebase_1.db.collection('products');
        for (const p of exports.INITIAL_PRODUCTS) {
            await prodRef.doc(p.slug).set(p);
        }
        const planRef = firebase_1.db.collection('subscription_plans');
        for (const plan of exports.INITIAL_PLANS) {
