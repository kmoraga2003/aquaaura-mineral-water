...
const products = [
  ...
  },
  {
    ...
    potassium_mg_l: 5.0,
    silica_mg_l: 31.0,
    description: "Saborizado naturally sin azúcares, endulzantes ni calorías. Sabor fresco e hidratación revitalizante.",
    badge: "Sin Azúcar",
    icon_type: "infused"
  }
];
...
ejs.renderFile(templatePath, { products, plans }, (err, str) => {
  if (err) {
    console.error('Error rendering static template:', err);
    process.exit(1);
  }
  fs.writeFileSync(outputPath, str);
  console.log('✅ public/index.html compiled successfully for Firebase Hosting deployment!');
});
