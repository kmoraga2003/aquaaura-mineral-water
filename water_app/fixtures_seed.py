from water_app.models import Product, SubscriptionPlan
...
def seed_database():
    ...
    for item in plans_data:
        SubscriptionPlan.objects.create(**item)

    print(f"✅ Se han cargado {Product.objects.count()} productos y {SubscriptionPlan.objects.count()} planes de suscripción.")
